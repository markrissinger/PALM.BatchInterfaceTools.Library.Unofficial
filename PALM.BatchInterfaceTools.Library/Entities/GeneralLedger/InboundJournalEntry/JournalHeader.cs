...
using static PALM.BatchInterfaceTools.Library.Constants.GeneralLedgerConstants;

namespace PALM.BatchInterfaceTools.Library.Entities.GeneralLedger.InboundJournalEntry
{
    public class JournalHeader
    {
        ...
        [Required]
        public AdjustingEntryValues AdjustingEntry { get; set; }
        [InterfaceFieldPosition(4)]
        internal string? AdjustingEntryFormatted { get { return Enum.GetName(typeof(AdjustingEntryValues), AdjustingEntry); } }

        [InterfaceFieldPosition(5)]
        [StringLength(maximumLength: 3, MinimumLength = 1)]
        public string? AdjustingPeriod { get; set; }
